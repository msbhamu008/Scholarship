    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="topLevelMenu container-fluid ">
                ...
                <div class="social">
                    <ul class="list-inline">		
						<li>Hello Admin</li> 
						<li>|</li> 
						<li><a href = "/sips/adminLogout">Sign Out</a></li>
						<li>|</li> 
            ...
            <div class="navbar-header">
                <div class="logoDiv">
                    <a href="#"><span><img src="/sips/images/sips_logo_edited_2.png" class="img-responsive" title="Sunrise International Public School" id="logo" width="370px;"/></span></a>					
                </div>
            </div>
        </nav>
<div class="container-fluid text-center">      
<div id="adminArea" class="adminArea" style="padding-top:185px;">    	
		<div class="row">
			<div class="col-sm-4">
				<div class="panel panel-primary" style="color:black;">
				  <div class="panel-heading">Notification Handler</div>
				  <div class="panel-body">
					<p>This Notification Handler will allow you to add a new notification to show on the Home Page. The added notification will be visible only for 4 days.<br> Please click on the button below to proceed</p>
				  </div>
				  <div class="panel-footer" style="background-color:white;">
					<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModal">Add Notification</button>
				  </div>
				</div>
			</div>
		</div>
	...
	<!-- Notification Modal -->
  <div class="modal fade" id="myModal" role="dialog" style="padding-top:170px; color:black;">
