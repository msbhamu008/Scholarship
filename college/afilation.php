			...
			<div class="main-bar clearfix ">
				...
				<div class="header-nav navbar-collapse collapse">
					<ul class=" nav navbar-nav">
						...
						<li> <a href="afilation.php"> <i class="fa fa-university" aria-hidden="true"></i> About Us<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
					...
					<li> <a href="afilation.php"> <i class="fa fa-user" aria-hidden="true"></i> Academic<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li> <a href="afilation.php"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Faculty<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li><a href="afilation.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Facilities<i class="fa fa-chevron-down"></i></a>
						<!-- <ul class="sub-menu">
					...
					<li><a href="afilation.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Syllabus<i class="fa fa-chevron-down"></i></a>
							<!-- <ul class="sub-menu">
            ...
            <div class="container">
                ...
                <div class="row clearfix">
                    <div class="col-md-12 m-b30 hidden-sm">
                                <img src="images/college_doc/Affilations1.png" style="width:100%;">
                            </div>
                        <div class="col-md-12 m-b30 hidden-sm">
                                <img src="images/college_doc/Affilations2.png" style="width:100%;">
                            </div>

                    <div class="content-side col-lg-12 col-md-12 col-sm-12 col-xs-12">
<p style="text-align: center;">
</p><p style="text-align: center;">The College Is Affiliated With</p>
<p style="text-align: center;"><strong>Pandit Deendayal Upadhyaya Shekhawati University, Sikar</strong></p>
                    </div>
                </div>
