			...
			<div class="main-bar clearfix ">
				...
				<div class="header-nav navbar-collapse collapse">
					<ul class=" nav navbar-nav">
						...
						<li> <a href="f-arts.php"> <i class="fa fa-university" aria-hidden="true"></i> About Us<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
					...
					<li> <a href="f-arts.php"> <i class="fa fa-user" aria-hidden="true"></i> Academic<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li> <a href="f-arts.php"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Faculty<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li><a href="f-arts.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Facilities<i class="fa fa-chevron-down"></i></a>
						<!-- <ul class="sub-menu">
					...
					<li><a href="f-arts.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Syllabus<i class="fa fa-chevron-down"></i></a>
							<!-- <ul class="sub-menu">
            ...
            <div class="container">
                <div class="section-content">
                    ...
                    <div class="content-side col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                         <div class="ba">
<h1 class="text-center" style="text-align: center;"><b>Bachelor of Arts</b></h1>
<div class="row">
<div class="col-md-6">
<ul>
<li><strong>Compulsory Subjects Offered :-</strong><br>
1. General Hindi<br>
2. General English<br>
3. Elementry Computer<br>
4. Environmental Study</li>
</ul>
</div>
<div class="col-md-6">
<ul>
<li style="text-align: left;"><strong>Optional Subjects Offered :-</strong><br>
1. Political Science<br>
2. History<br>
3. Hindi Literatare<br>
4. Geography<br>
5. English Literture<br>
6. Economies</li>
7. Mathematics</li>
</ul>
...
<h1 class="text-center" style="text-align: center;"><b>Master of Arts</b></h1>
<div class="col-md-6">
<ul>
<br>
1. Political Science<br>
...
<div class="col-md-6">
<ul>
<li><strong>Subjects Offered :-</strong><br>
1. Political Science<br>
2. History<br>
3. Geography<br>
4. English Literture</li>
</ul>-->
</div>
</div>
</div>
