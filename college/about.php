...
<!--			  <li><a href="" target="_blank"><i class="fa fa-facebook text-facebook" style="padding: 3px 3px 3px 3px;vertical-align: middle;"></i></a></li>
			...
			<div class="main-bar clearfix ">
				...
				<div class="header-nav navbar-collapse collapse">
					<ul class=" nav navbar-nav">
						...
						<li> <a href="about.php"> <i class="fa fa-university" aria-hidden="true"></i> About Us<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
					...
					<li> <a href="about.php"> <i class="fa fa-user" aria-hidden="true"></i> Academic<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li> <a href="about.php"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Faculty<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li><a href="about.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Facilities<i class="fa fa-chevron-down"></i></a>
						<!-- <ul class="sub-menu">
					...
					<li><a href="about.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Syllabus<i class="fa fa-chevron-down"></i></a>
							<!-- <ul class="sub-menu">
    ...
    <div class="page-content">
		...
		<div class="container">
				...
				<img src="images/main-slider/slide9.png">
				</div>
			</div>
        <!-- About Company -->
...
<p>Sunrise College Sikar Education was founded in 2021 by a dynamic and results-driven team of highly qualified individuals from diverse professional backgrounds. This collaborative effort aimed to champion the noble cause of delivering top-notch education. Beginning in 2021, Sunrise College has been offering programs in Arts and Commerce.</p>

<p>The primary mission of Sunrise College is to align with the evolving and progressive global landscape by empowering the youth. The institution is committed to nurturing the younger generation, equipping them with the knowledge and confidence needed to thrive in a rapidly changing, competitive world, all while preserving our rich traditions, humanity, spirituality, and the essence of our existence. Our foremost objective in teacher's training courses is to enable prospective educators to acquire the competence required to teach their specialized subjects, grounded in a solid theoretical understanding of learning and a profound knowledge of their respective fields. Our aim is to cultivate an awareness of the intricate relationship between society and the college, as well as the interplay between life and the institution, and the broader context of social work.</p>

<p>In our nation's educational pursuit, we seek a harmonious balance between material goals and spiritual values, and the delicate equilibrium between the individual and society. In the modern era, India yearns for renewed vigor in its national outlook, demanding courage and scientific acumen. While educational reforms have been contemplated in theory, their practical implementation has often been overlooked, with their true value obscured. Hence, it is imperative that we instill practical and resilient attitudes in our youth.
</p>
...
<p  style="text-align: center;"> <!--<img src="images/college_doc/aboutland.png">--> </p>
                    </div>
                </div>
...
<footer class="site-footer">
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-6 footer-col-4">
						<div class="widget widget_getintuch">
							...
							<div class="rdx-separator bg-primary"></div>
							<ul>
								<li><i class="fa fa-map-marker"></i><strong>address</strong> Jaipur-Bikaner Bypass Road, Palwas, Sikar (Raj.)-332001</li>
								<li><i class="fa fa-phone"></i><strong>phone (24/7 Support Line)</strong>
									+91 96109-99938 
								<br/>+91 96106-52222 </li>
								<li><i class="fa fa-envelope"></i><strong>Email</strong>sunriseschool33@gmail.com</li>
							</ul>
						</div>
					</div>
				</div>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					 <li class="font-11 text-black-777 " style="text-align:center;">Copyright &copy;2016 <a href="https://www.sunriseeduhub.com" target="_blank">Prince Education Hub</a>. All Rights Reserved</li>
				</div>
			</div>
		</div>
	</footer>
