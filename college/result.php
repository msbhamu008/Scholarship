			...
			<div class="main-bar clearfix ">
				...
				<div class="header-nav navbar-collapse collapse">
					<ul class=" nav navbar-nav">
						...
						<li> <a href="result.php"> <i class="fa fa-university" aria-hidden="true"></i> About Us<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
					...
					<li> <a href="result.php"> <i class="fa fa-user" aria-hidden="true"></i> Academic<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li> <a href="result.php"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Faculty<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li><a href="result.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Facilities<i class="fa fa-chevron-down"></i></a>
						<!-- <ul class="sub-menu">
					...
					<li><a href="result.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Syllabus<i class="fa fa-chevron-down"></i></a>
							<!-- <ul class="sub-menu">
            ...
            <div class="container">
                ...
                <div class="row clearfix">
                    <div class="content-side col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                         <img src="images/result/Result-2023.jpg">
                                                         <hr/>
                                                         <img src="images/result/BA-Result-2023.jpg">
                                                         <!--<img src="images/result/3.jpg">
                                                         <img src="images/result/4.jpg">
                                                         <img src="images/result/5.jpg">
                                                         <img src="images/result/6.jpg">
                                                         <img src="images/result/7.jpg">
                                                         <img src="images/result/8.jpg">
                                                         <img src="images/result/9.jpg">
                                                         <img src="images/result/10.jpg">
                                                         <img src="images/result/11.jpg">
                                                         <img src="images/result/12.jpg">
                                                         <img src="images/result/13.jpg">
                                                         <img src="images/result/14.jpg">
                                                         <img src="images/result/15.jpg">
                                                         <img src="images/result/16.jpg">
                                                         <img src="images/result/17.jpg">
                                                         <img src="images/result/18.jpg">-->
                    </div>
                </div>
