			...
			<div class="main-bar clearfix ">
				...
				<div class="header-nav navbar-collapse collapse">
					<ul class=" nav navbar-nav">
						...
						<li> <a href="vision.php"> <i class="fa fa-university" aria-hidden="true"></i> About Us<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
					...
					<li> <a href="vision.php"> <i class="fa fa-user" aria-hidden="true"></i> Academic<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li> <a href="vision.php"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Faculty<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li><a href="vision.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Facilities<i class="fa fa-chevron-down"></i></a>
						<!-- <ul class="sub-menu">
					...
					<li><a href="vision.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Syllabus<i class="fa fa-chevron-down"></i></a>
							<!-- <ul class="sub-menu">
            ...
            <div class="container">
                ...
                <div class="row clearfix">
                    ...
                    <br><br>
                                                            <h2>Vision</h2>                                     
					<p>
Education in the context of the child, should be formative, informative and motivative. The mind of the child is both receptive and selective. A proper attractive environment, a technique that would evoke curiosity and interest, plus an inducement, subtle but strong, to make the child ” think for him/her” and above all, expression of lavish and loving concern, are all important factors in child education which no educational institution can afford to overlook.</p>
<p>⦁ To establish and run an educational set-up for a strong, young generation.<br>
⦁ To enable the pupils to receive the right education from dedicated teachers under dynamic administration.<br>
⦁ To prepare children for complete living.<br>
⦁ To impart a sound and all round education to the child irrespective of caste, creed or religion.<br>
⦁ To provide proper orientation to the child aimed at drawing out his/her latent potentialities.<br>
⦁ To orient the child to develop a strong character, self-reliance, integrity, fellow feeling and a sense of duty towards society and the nation.<br>
⦁ To orient the child to strive for excellence in every field.<br>
⦁ To foster realistic understanding, appreciation and faith in the culture of India.<br>
⦁ To prepare children for a democratic way of life.<br>
⦁ To equip children with the futuristic outlook suited to meritocratic-society.</p>
                    </div>
                </div>
