			...
			<div class="main-bar clearfix ">
				...
				<div class="header-nav navbar-collapse collapse">
					<ul class=" nav navbar-nav">
						...
						<li> <a href="ias-pre.php"> <i class="fa fa-university" aria-hidden="true"></i> About Us<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
					...
					<li> <a href="ias-pre.php"> <i class="fa fa-user" aria-hidden="true"></i> Academic<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li> <a href="ias-pre.php"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Faculty<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li><a href="ias-pre.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Facilities<i class="fa fa-chevron-down"></i></a>
						<!-- <ul class="sub-menu">
					...
					<li><a href="ias-pre.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Syllabus<i class="fa fa-chevron-down"></i></a>
							<!-- <ul class="sub-menu">
                ...
                <div class="section-content">
                    <div class="row">
						<div class="col-md-12 m-b30 hidden-sm">
                            <p></p><center><p></p>
<h3>Syllabus : IAS – Preliminary</h3>
<p></p></center><br><br>
<strong>Paper I (200 marks) Duration : 2 hours</strong><p></p>
<p>Current events of national and international importance
	<br>
...
<br><br>
Change – that do not require subject specialisation General Science</p>
<p><strong>Paper II-(200 marks) Duration : 2 hours</strong></p>

<p>Comprehension<br><br>
Interpersonal skills including communication skills;<br><br>
Logical reasoning and analytical ability<br><br>
Decision-making and problem solving<br><br>
General mental ability<br><br>
Basic numeracy (numbers and their relations, orders of magnitude, etc.) (Class X level), Data interpretation (charts, graphs, tables, data sufficiency etc. – Class X level)</p>

<p><b>Note 1:</b> The CSAT aptitude test or Paper-II of the Civil Services (Preliminary) examination will be a qualifying paper only with a minimum of 33% to be secured to sit for the Civil Services (Mains) exam.<br><br>
<b>Note 2:</b> The questions in both Paper-I (current affairs) and Paper-II (aptitude test) will be of multiple choice, objective type for 200 marks each and the time allotted for each paper is two hours<br><br>
<b>Note 3:</b> It is mandatory for the candidate to appear in both the papers of Civil Services (Prelim) examination for the purpose of evaluation. Therefore a candidate will be disqualified in case he or she does not appear in both the papers of the (Prelims) exam.</p>
                            </div>
