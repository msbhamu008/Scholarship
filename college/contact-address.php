...
<!--			  <li><a href="" target="_blank"><i class="fa fa-facebook text-facebook" style="padding: 3px 3px 3px 3px;vertical-align: middle;"></i></a></li>
			...
			<div class="main-bar clearfix ">
				...
				<div class="header-nav navbar-collapse collapse">
					<ul class=" nav navbar-nav">
						...
						<li> <a href="contact-address.php"> <i class="fa fa-university" aria-hidden="true"></i> About Us<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
					...
					<li> <a href="contact-address.php"> <i class="fa fa-user" aria-hidden="true"></i> Academic<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li> <a href="contact-address.php"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Faculty<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li><a href="contact-address.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Facilities<i class="fa fa-chevron-down"></i></a>
						<!-- <ul class="sub-menu">
					...
					<li><a href="contact-address.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Syllabus<i class="fa fa-chevron-down"></i></a>
							<!-- <ul class="sub-menu">
    ...
    <div class="page-content">
        ...
        <div class="section-full bg-white content-inner">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12 m-b30">
                        <div class="icon-bx-wraper center bg-white p-a30">
                            <div class="icon-bx-sm bg-primary m-b20" style='float:left;'> <a href="contact-address.php" class="icon-cell"><i class="fa fa-phone"></i> </a></div>
                            <div class="icon-content" style='float:right;'>
                                <h5>Phone</h5>
                                <p>098285 12821 </br>8800305186 </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 m-b30">
                        <div class="icon-bx-wraper center bg-white p-a30">
                            <div class="icon-bx-sm bg-primary m-b20" style='float:left;'> <a href="contact-address.php" class="icon-cell"><i class="fa fa-envelope"></i></a> </div>
                            <div class="icon-content" style='float:right;'>
                                <h6>Email</h6>
                                <p>sunriseschool@gmail.com</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-12  m-b30">
                        <div class="icon-bx-wraper center bg-white p-a30">
                            <div class="icon-bx-sm bg-primary m-b20" style='float:left;'> <a href="contact-address.php" class="icon-cell"><i class="fa fa-map-marker"></i></a> </div>
                            <div class="icon-content" style='float:right;'>
                                <h5>Address</h5>
                                <p>Salasar Main Rd, Nechwa-332026</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <iframe src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=Sunrise College for Higher Studies Nechhwa&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" width="100%" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
	...
	<footer class="site-footer">
       ...
       <!--                     <li><a href="ug-scholarship.php">Scholarship</a></li>-->
					...
					<div class="col-md-3 col-sm-6 footer-col-4">
						<div class="widget widget_getintuch">
							...
							<ul>
								...
								<li><i class="fa fa-envelope"></i><strong>Email</strong>sunrisecollege@gmail.com</li>
							</ul>
						</div>
					</div>
				</div>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					 <li class="font-11 text-black-777 " style="text-align:center;">Copyright &copy;2016 <a href="https://www.college.sunriseeduhub.com" target="_blank">Prince Education Hub</a>. All Rights Reserved</li>
				</div>
			</div>
		</div>
	</footer>
