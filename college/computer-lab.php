			...
			<div class="main-bar clearfix ">
				...
				<div class="header-nav navbar-collapse collapse">
					<ul class=" nav navbar-nav">
						...
						<li> <a href="computer-lab.php"> <i class="fa fa-university" aria-hidden="true"></i> About Us<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
					...
					<li> <a href="computer-lab.php"> <i class="fa fa-user" aria-hidden="true"></i> Academic<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li> <a href="computer-lab.php"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Faculty<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li><a href="computer-lab.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Facilities<i class="fa fa-chevron-down"></i></a>
						<!-- <ul class="sub-menu">
					...
					<li><a href="computer-lab.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Syllabus<i class="fa fa-chevron-down"></i></a>
							<!-- <ul class="sub-menu">
                ...
                <div class="section-content">
                    <div class="row">
						<div class="col-md-6 m-b30 hidden-sm">
                            ...
                            <p>Modern computer labs, comprising of latest operating system and hardware with UPS supply. We have a euqipped computer Lab with latest Pentium &amp; High Speed Internet facilities.<br>
There are more than100 computers in our labs currently. They are state-of-the-art with multimedia, most of them with 17″ LCD monitors that are easier on eyes, generate less heat and consume less power thereby keeping the classroom atmosphere comfortable for students.<br>
the school is equipped with a dedicated broadband Internet connection for enterprising students get a chance to be familiar with the Internet.<br>
Hi-Tech, Wi-fi in-built Computer Lab.<br>
Recent Version of Software.<br>
Computers with TFT &amp; Plasma Screen.<br>
24 hour’s Internet.</p>
                        
                            </div>
                      
                        <div class="col-md-6">
                        
  <img src="images/gallery/cl.jpg" style="width:100%;">
