			...
			<div class="main-bar clearfix ">
				...
				<div class="header-nav navbar-collapse collapse">
					<ul class=" nav navbar-nav">
						...
						<li> <a href="auditorium.php"> <i class="fa fa-university" aria-hidden="true"></i> About Us<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
					...
					<li> <a href="auditorium.php"> <i class="fa fa-user" aria-hidden="true"></i> Academic<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li> <a href="auditorium.php"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Faculty<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li><a href="auditorium.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Facilities<i class="fa fa-chevron-down"></i></a>
						<!-- <ul class="sub-menu">
					...
					<li><a href="auditorium.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Syllabus<i class="fa fa-chevron-down"></i></a>
							<!-- <ul class="sub-menu">
                ...
                <div class="section-content">
                    <div class="row">
						<div class="col-md-6 m-b30 hidden-sm">
                            <p>Sunrise College provides a platform to its student’s talent in the form of organizing different cultural programmes like welcome party, Thanks party, several competitions, conferences, seminars etc.</p>
<p>The auditorium with state-of-the-art multimedia system. It is frequently used for presentations, seminars, fests, events of the college. It is equipped with a large stage, comfortable seating,&nbsp;carpeting, wall paneling for acoustic effects &amp;&nbsp;air-conditioners.</p>
                        
                            </div>
                      
                        <div class="col-md-6">
                         <img src="images/gallery/audi.jpg" style="width:100%;">
