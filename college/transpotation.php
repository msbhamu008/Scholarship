			...
			<div class="main-bar clearfix ">
				...
				<div class="header-nav navbar-collapse collapse">
					<ul class=" nav navbar-nav">
						...
						<li> <a href="transpotation.php"> <i class="fa fa-university" aria-hidden="true"></i> About Us<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
					...
					<li> <a href="transpotation.php"> <i class="fa fa-user" aria-hidden="true"></i> Academic<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li> <a href="transpotation.php"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Faculty<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li><a href="transpotation.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Facilities<i class="fa fa-chevron-down"></i></a>
						<!-- <ul class="sub-menu">
					...
					<li><a href="transpotation.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Syllabus<i class="fa fa-chevron-down"></i></a>
							<!-- <ul class="sub-menu">
                ...
                <div class="section-content">
                    <div class="row">
						<div class="col-md-6 m-b30 hidden-sm">
                            <p>  The College is maintaining an excellent fleet of comfortable, well maintained, air conditioned buses with trained staff. The college transport is provided to students on first-cum-first serve basis, subject to availability of seats. The main aim is to provide safe, comfortable and efficient service to our students.&nbsp;There is no compromise with the safety aspects and guidelines are strictly adhered to.<br>
Sunrise College rovides bus facility to its students up to 50 Km distance from the College, covers 90 villages area.&nbsp;Bus charges varies according to the route and distance covered. The college buses are manned by highly trained and well – behaved drivers and conductors.<br>
For details of the Route(s) followed in each zone, kindly contact the Manager – Security &amp; Transport , with your detailed residential address including landmarks, if any</p>
                        
                            </div>
                      
                        <div class="col-md-6">
                        <img src="images/gallery/bus.jpg" style="width:100%;">
