			...
			<div class="main-bar clearfix ">
				...
				<div class="header-nav navbar-collapse collapse">
					<ul class=" nav navbar-nav">
						...
						<li> <a href="director.php"> <i class="fa fa-university" aria-hidden="true"></i> About Us<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
					...
					<li> <a href="director.php"> <i class="fa fa-user" aria-hidden="true"></i> Academic<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li> <a href="director.php"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Faculty<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li><a href="director.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Facilities<i class="fa fa-chevron-down"></i></a>
						<!-- <ul class="sub-menu">
					...
					<li><a href="director.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Syllabus<i class="fa fa-chevron-down"></i></a>
							<!-- <ul class="sub-menu">
...
<p><strong>“Hope is believing that you have the will and the way to accomplish your goals”</strong></p>
<p>Hello !</p>
<p>Your most welcome in our academic field. Education gains it’s significance and value. When the right kind of inputs are received from the right kind of people in the right environment.</p>
<p>In Sunrise College the success is measured by five key qualities Love, Self Confidence, Discipline, Determination and Humanity. We give the education in the direction of development for these quality special emphasis is laid on participation in co-curricular activities. we made as we are following CCE i.e. continuous and Comprehensive Evaluation of a child, it has been set up to produce future leaders who are self reliant, self confident. Versatile with the courage of the conviction and endowed with a spirit of adventure and creativity.So now let start journey with hope and enthusiasm.</p>
