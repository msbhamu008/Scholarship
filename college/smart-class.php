			...
			<div class="main-bar clearfix ">
				...
				<div class="header-nav navbar-collapse collapse">
					<ul class=" nav navbar-nav">
						...
						<li> <a href="smart-class.php"> <i class="fa fa-university" aria-hidden="true"></i> About Us<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
					...
					<li> <a href="smart-class.php"> <i class="fa fa-user" aria-hidden="true"></i> Academic<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li> <a href="smart-class.php"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Faculty<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li><a href="smart-class.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Facilities<i class="fa fa-chevron-down"></i></a>
						<!-- <ul class="sub-menu">
					...
					<li><a href="smart-class.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Syllabus<i class="fa fa-chevron-down"></i></a>
							<!-- <ul class="sub-menu">
                ...
                <div class="section-content">
                    <div class="row">
						<div class="col-md-12 m-b30 hidden-sm">
                            <h4>Smart Classes</h4>
<p>  <img src="images/gallery/smartClass.png" style="width:25%;float:left;margin-right:10px;"> A Smart Classroom is a traditional lecture style teaching space that has available technological equipment that can be used to aid and enhance instruction of a course. The smart class room is equipped with the basic technology that will enable to connect laptop to the projector.<br>
Spacious and well ventilated classrooms. Slide Projector, OHP, VCR, Infosys and Infotech aids are used to enhance the teaching-learning process. CD, Multimedia and Internet facilities are also available.&nbsp;Smart Classrooms is a comprehensive strategy for digital education in Sunrise College, Sikar.</p>
