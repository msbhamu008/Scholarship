			...
			<div class="main-bar clearfix ">
				...
				<div class="header-nav navbar-collapse collapse">
					<ul class=" nav navbar-nav">
						...
						<li> <a href="lab.php"> <i class="fa fa-university" aria-hidden="true"></i> About Us<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
					...
					<li> <a href="lab.php"> <i class="fa fa-user" aria-hidden="true"></i> Academic<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li> <a href="lab.php"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Faculty<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li><a href="lab.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Facilities<i class="fa fa-chevron-down"></i></a>
						<!-- <ul class="sub-menu">
					...
					<li><a href="lab.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Syllabus<i class="fa fa-chevron-down"></i></a>
							<!-- <ul class="sub-menu">
                ...
                <div class="section-content">
                    <div class="row">
						<div class="col-md-6 m-b30 hidden-sm">
                         <p>Our College houses modern hi tech labs (Physics, Chemistry, and Biology &amp; Maths) for practical and experiments. These labs are equipped with necessary tools, systems, devices, learning material and infrastructure. We appreciate the importance of labs for a student and make every effort to enrich the learning experience inside the lab. The laboratories are available for batch-wise conduct of practicals in all 4 subjects.</p>
<p>The classes are conducted only in the presence of the educators concerned and the lab-assistants.</p>
                            </div>
                        <div class="col-md-6">
                            <img src="images/lab.jpg" style="border-radius: 5px;" >
                        </div>
                    </div>
                </div>
            </div>
