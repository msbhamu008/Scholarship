			...
			<div class="main-bar clearfix ">
				...
				<div class="header-nav navbar-collapse collapse">
					<ul class=" nav navbar-nav">
						...
						<li> <a href="chairman.php"> <i class="fa fa-university" aria-hidden="true"></i> About Us<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
					...
					<li> <a href="chairman.php"> <i class="fa fa-user" aria-hidden="true"></i> Academic<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li> <a href="chairman.php"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Faculty<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li><a href="chairman.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Facilities<i class="fa fa-chevron-down"></i></a>
						<!-- <ul class="sub-menu">
					...
					<li><a href="chairman.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Syllabus<i class="fa fa-chevron-down"></i></a>
							<!-- <ul class="sub-menu">
...
<p>The world scenario is changing rapidly due to liberalization &amp; globalization. The teaching methodology followed by most of the main stream school is taxing . The focus is more on memorizing than enhancing the students analytical skills. The academic curriculum is very rigorous leaving no room for extracurricular activities.</p>
<p>The focus of entire learning process in SKNIE is on grooming students to become responsible global citizens retaining the Indian ethos. So ,while their hearts will stay firmly planted in Indian soil, their minds will travel across the globe gathering pulse of wisdom in the process getting ready for the world &amp; the future ahead.</p>
<p>I wish you a very good luck for your future to all of you students.</p>
