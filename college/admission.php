			...
			<div class="main-bar clearfix ">
				...
				<div class="header-nav navbar-collapse collapse">
					<ul class=" nav navbar-nav">
						...
						<li> <a href="admission.php"> <i class="fa fa-university" aria-hidden="true"></i> About Us<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
					...
					<li> <a href="admission.php"> <i class="fa fa-user" aria-hidden="true"></i> Academic<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li> <a href="admission.php"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Faculty<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li><a href="admission.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Facilities<i class="fa fa-chevron-down"></i></a>
						<!-- <ul class="sub-menu">
					...
					<li><a href="admission.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Syllabus<i class="fa fa-chevron-down"></i></a>
							<!-- <ul class="sub-menu">
            ...
            <div class="container">
                <div class="section-content">
                    ...
                    <div class="content-side col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                         <p><strong>Registration</strong> – Parents are requested to submit their ward’s registration form on the specified date.</p>
<p>⦁ Eligible candidates are advised to deposit the duly-filled in Application Forms along with necessary documents by the due date.<br>
⦁ Admission will be treated as final only when fee has been deposited. if not deposited by the due date the admission will be cancelled.<br>
⦁ Fee once deposited shall not be refunded.<br>
⦁ Please obtain your Fee Deposit Receipt which should be kept safely for future use.<br>
⦁ Admission can be refused and cancelled by the Director/Principal without assigning any reason.<br>
⦁ The Advisory Committee will guide and help the students as and when needed.</p>
<p><strong>General Rules for Admission</strong> : (For fresh students) following document s are compulsory…</p>
<p>⦁ Original &amp; one photocopy of Secondary Examination Mark Sheet.<br>
⦁ Original &amp; one photocopy of the qualifying examination Mark Sheet.<br>
⦁ Original Transfer Certificate from the previous institution.<br>
⦁ Original Character Certificate from the previous institution.<br>
⦁ Original Migration Certificate (other than students from Rajasthan Board)<br>
⦁ Two passport size colored recent photographs.</p>
                    </div>
                </div>
