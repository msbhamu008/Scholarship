			...
			<div class="main-bar clearfix ">
				...
				<div class="header-nav navbar-collapse collapse">
					<ul class=" nav navbar-nav">
						...
						<li> <a href="eligiblity.php"> <i class="fa fa-university" aria-hidden="true"></i> About Us<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
					...
					<li> <a href="eligiblity.php"> <i class="fa fa-user" aria-hidden="true"></i> Academic<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li> <a href="eligiblity.php"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Faculty<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li><a href="eligiblity.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Facilities<i class="fa fa-chevron-down"></i></a>
						<!-- <ul class="sub-menu">
					...
					<li><a href="eligiblity.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Syllabus<i class="fa fa-chevron-down"></i></a>
							<!-- <ul class="sub-menu">
            ...
            <div class="container">
                <div class="section-content">
                    ...
                    <div class="content-side col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                         <p>Eligibility Criteria For The Following Courses :-</p>
<p>Bachelor of Arts (B.A.)<br>
Eligibility: Minimum 45% marks in XII<br>
Duration : Three years- Annual scheme.</p>
<p>Bachelor of Science (B.Sc.) [Mathematics/Biology]<br>
Eligibility: Minimum 48% marks in XII<br>
Duration : Three years- Annual scheme.</p>
<p><strong>RULES FOR ATTENDANCE</strong></p>
<p>For every student the compulsory attendance is 75% separately in theory and practical classes. If the attendance is found less than 75%, student will not be permitted to appear in the University Examination.<br>
The student who represents the college in cultural, sports, academic, NSS or any other such activity, she will be positively marked present for that duration.<br>
Rules And Regulation<br>
Admission will be taken on fix seats as per rule of Pandit Deendayal Upadhyay Shekhawati University.<br>
No Admission after last date which declared by the Pandit Deendayal Upadhyay Shekhawati University.<br>
All Students should be well disciplined.<br>
Mobile &amp; other entertaining instruments are strictly prohibited.<br>
Every student of this college will inform that his/her form will be rejected if they have misbehaved.<br>
College fee is non-refundable in any condition.<br>
Students must always carry Identity Card and produce it on demand.<br>
As per the University norms regular attendance of the students for theory and Practical is necessary, 75% of the attendance in compulsory for taking the University Examination.<br>
Students should be taken in handling the college Equipments. Students will be personally liable for any damage caused to the college property.<br>
Students should be read important information’s daily at notice board. College Time-Table shall be notified on the notice board.<br>
All Students will be present in College Uniform daily.</p>
                    </div>
                </div>
