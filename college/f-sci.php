			...
			<div class="main-bar clearfix ">
				...
				<div class="header-nav navbar-collapse collapse">
					<ul class=" nav navbar-nav">
						...
						<li> <a href="f-sci.php"> <i class="fa fa-university" aria-hidden="true"></i> About Us<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
					...
					<li> <a href="f-sci.php"> <i class="fa fa-user" aria-hidden="true"></i> Academic<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li> <a href="f-sci.php"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Faculty<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li><a href="f-sci.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Facilities<i class="fa fa-chevron-down"></i></a>
						<!-- <ul class="sub-menu">
					...
					<li><a href="f-sci.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Syllabus<i class="fa fa-chevron-down"></i></a>
							<!-- <ul class="sub-menu">
            ...
            <div class="container">
                <div class="section-content">
                    ...
                    <div class="content-side col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                         <h1 class="text-center"><u>Bachelor of Science</u></h1>
<div class="row">
<div class="col-md-6">
<ul>
...
<div class="col-md-6">
<p style="text-align: left;"><strong>Optional Subjects Offered :-</strong><br>
1. Chemistry<br>
2. Physics<br>
3. Mathematics<br>
4. Zoology<br>
...
<p>&nbsp;</p>
<hr>
<!--<h1 class="text-center"><u>Master of Science</u></h1>
<div class="row">
<div class="col-md-6">
<ul>
