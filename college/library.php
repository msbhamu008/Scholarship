			...
			<div class="main-bar clearfix ">
				...
				<div class="header-nav navbar-collapse collapse">
					<ul class=" nav navbar-nav">
						...
						<li> <a href="library.php"> <i class="fa fa-university" aria-hidden="true"></i> About Us<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
					...
					<li> <a href="library.php"> <i class="fa fa-user" aria-hidden="true"></i> Academic<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li> <a href="library.php"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Faculty<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li><a href="library.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Facilities<i class="fa fa-chevron-down"></i></a>
						<!-- <ul class="sub-menu">
					...
					<li><a href="library.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Syllabus<i class="fa fa-chevron-down"></i></a>
							<!-- <ul class="sub-menu">
        ...
        <div class="section-full bg-white content-inner">
            <div class="container">
                <div class="section-content">
                    <div class="row">
						<div class="col-md-6 m-b30 hidden-sm">
                            <p>A library is the heart of an academic institution. Our institution encourages all students and staff members to make the best use of the library that has been carefully built up since the inception of the College. An up to date full-fledged library is maintend by a qualified librarian. The library is well stocked &amp; stacked with more than 8000 books on modern subjects.</p>
<p>The library is computerized and equipped with a Photocopier for taking copies of any relevant article from the reference section of the library. It has got a state-of-the-art digital library with high speed Internet facility.</p>
<h4>
Rules and regulations for library</h4>
<p>Silence must be observed in the library.<br>
Personal belongings are not allowed inside the library.<br>
All students should sign the entry register of the library, before entering.<br>
Books are to be handled very carefully. If a book is lost by the student, he/she shall replace the book or pay the cost of the book as fine.<br>
Students are not permitted to underline, write, fold the pages or deface books in any way whatsoever.<br>
At the end of the session the students must return their token and library book based on the library circular and obtain “No Dues Certificate” from the library.</p>
                        
                            </div>
                      
                        <div class="col-md-6">
                        
 <img src="images/lib.jpg" style="border-radius: 5px;" >
                        </div>
                    </div>
                </div>
            </div>
