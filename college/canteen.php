			...
			<div class="main-bar clearfix ">
				...
				<div class="header-nav navbar-collapse collapse">
					<ul class=" nav navbar-nav">
						...
						<li> <a href="canteen.php"> <i class="fa fa-university" aria-hidden="true"></i> About Us<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
					...
					<li> <a href="canteen.php"> <i class="fa fa-user" aria-hidden="true"></i> Academic<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li> <a href="canteen.php"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Faculty<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li><a href="canteen.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Facilities<i class="fa fa-chevron-down"></i></a>
						<!-- <ul class="sub-menu">
					...
					<li><a href="canteen.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Syllabus<i class="fa fa-chevron-down"></i></a>
							<!-- <ul class="sub-menu">
            ...
            <div class="container">
                <div class="section-content">
                    <div class="row">
                        ...
                        <p>Sunrise College takes care to provide healthy refreshment to its students in view of the demands of the students.<br>
While studying …….students often get so Hungry &amp; Tired that Food &amp; Rest cannot appear to them except in the form of CANTEEN and The College provides its students, staff and faculty with an amazing café experience in the college campus with its well maintained and well equipped Cafeteria. The cafeteria is not just a food joint but a place to relax, interact, rejuvenate and take a refuge from the daily hectic schedule!!!<br>
Our Canteen is committed to satisfying the nutrition needs of our community, in a practical and efficient manner, while maintaining a comfortable and amenable environment for food consumption. We strive to offer a variety of healthy and nutritional options for meals and snacks. Most of the items sold in the cafeteria are hand made by our highly qualified personnel.<br>
The cafeteria / canteen remains open on all working days. It provides all types of nutritious and hygienic eatables and beverages to cater to the students &amp; staff.</p>
                            </div>
