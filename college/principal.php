			...
			<div class="main-bar clearfix ">
				...
				<div class="header-nav navbar-collapse collapse">
					<ul class=" nav navbar-nav">
						...
						<li> <a href="principal.php"> <i class="fa fa-university" aria-hidden="true"></i> About Us<i class="fa fa-chevron-down"></i></a>
							<ul class="sub-menu">
					...
					<li> <a href="principal.php"> <i class="fa fa-user" aria-hidden="true"></i> Academic<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li> <a href="principal.php"> <i class="fa fa-graduation-cap" aria-hidden="true"></i> Faculty<i class="fa fa-chevron-down"></i></a>
						<ul class="sub-menu">
					...
					<li><a href="principal.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Facilities<i class="fa fa-chevron-down"></i></a>
						<!-- <ul class="sub-menu">
					...
					<li><a href="principal.php"> <i class="fa fa-tasks" aria-hidden="true"></i> Syllabus<i class="fa fa-chevron-down"></i></a>
							<!-- <ul class="sub-menu">
...
<p>You are indeed blessed to find an opportunity to get education at one of the best colleges of Shekhawati Region, Sunrise College, Sikar.</p>
<p>The college has the privilege of having a healthy, harmonious ambience and rich values which have played pivotal role in shaping the future of innumerable students. Our mission is to transform students into rational thinkers, competent workers, law abiding citizens and spiritually enlightened individuals. This college belief that the rich values and traditions imbibed here would carry you to greater heights.</p>
<p>To be successful in life, have ambitions and define your goals clearly. Discipline and hard work is the key to success. Be regular in your classes and focus on your goals. Yourconcertedefforts with the able guidance of your teachers would definitely provide you a blissful and successful life.</p>
<p>I welcome you all to this great institution of higher learning and assure you of a nurturing and caring environment that will see all of you blossom into empowered and sensitive human beings</p>
