            ...
            <div class="col-md-12">
                <div class="box removeboxmius">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('template_wise_rank'); ?></h3>
                    </div>
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('cbseexam/exam/rank_ajax') ?>" method="post" class="row class_search_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <select  id="template" name="template" class="form-control" >
                                        ...
                                        foreach ($templates as $template_key => $template_value) {
                                            ?>
                                            <option value="<?php echo $template_value['id'] ?>" <?php
                                            if (set_value('template') == $template_value['id']) {
                                                echo "selected=selected";
                                            }
                                            ?>><?php echo $template_value['name'] ?></option>
                                            <?php
                                                }
                                            ?>                                      
                                    </select>
                                    <span class="text-danger"  id="error_template"><?php echo form_error('template'); ?></span>
                                </div>
                            </div> 
                            <div class="col-sm-12">
                                <div class="form-group">
