            ...
            <div class="topLevelMenu container-fluid ">
                ...
                <div class="social">
                    <ul class="list-inline">
                        <li><a href="https://sunriseeduhub.com/web/disclosures">Mandatory Public Disclosure</a></li>
                        <li> | </li>
...
<!--                    <h3 style="color : #2874A6;">Videos</h3>-->
<!--					<iframe width="420" height="345" frameborder="0" src="https://www.youtube.com/embed/cMfY4a54Lv0" allowfullscreen>-->
<!--					</iframe>-->
<!--                </div>-->
<!--                <div class="col-sm-4 text-center">-->
<!--                    <h3 style="color : #2874A6;">School In News</h3>-->
<!--					<iframe width="420" height="345" frameborder="0" src="https://www.youtube.com/embed/cMfY4a54Lv0" allowfullscreen>-->
<!--					</iframe>-->
<!--                </div>-->
<!--                <div class="col-sm-4 text-center">-->
<!--                    <h3 style="color : #2874A6;">Notification</h3>-->
<!--                     <iframe width="420" height="345" src="notification.php" scrolling="no"  frameborder="0">-->
<!--					</iframe>-->
<!--                </div>-->
<!--            </div>          -->
<!--            </div>-->
                ...
                <div class="row">
                    <div class="col-sm-7">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <ul style="list-style: none;">  
                                 <li><a href="MandatoryDisclosure _ SARAS 5.0.pdf" target="_blank"><span>Mandatory Public Disclosure</span></a></li>
                                    <li><a href="gallery.php"><span>Gallery</span></a></li>
