<?php
           ...
           ?>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">Rank --r</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
            ...
            <a href="<?php echo base_url(); ?>student/view/<?php echo $student_value->id; ?>"><?php echo $this->customlib->getFullName($student_value->firstname,$student_value->middlename,$student_value->lastname,$sch_setting->middlename,$sch_setting->lastname); ?>
                                ...
                                <button type="submit" name="search"  class="btn btn-primary pull-right btn-sm checkbox-toggle" autocomplete="off"><i class="fa fa-search"></i> Generate Rank --r</button>
                                </div>
                            </div>     
                            </div> 
                        </form>
